...
/**
 * print_magic - Print the magic nos of a header
 ...
 * @e_ident: ptr to an array that contain the ELF class.
 */
 ...
 * @e_ident: A ptr to an array containing the version of ELF
 */
 ...
 * @e_type: The ELF type
 * @e_ident: ptr to an array that contains the class ELF
 */
 ...
 * @e_ident: ptr to an array that has the ELF class
 */
